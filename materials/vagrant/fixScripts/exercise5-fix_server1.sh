...
echo '	IdentityFile /home/vagrant/.ssh/private_key2' | sudo tee -a /home/vagrant/.ssh/config
echo '	IdentitiesOnly yes' | sudo tee -a /home/vagrant/.ssh/config
echo 'cp /vagrant/.vagrant/machines/server2/virtualbox/private_key /home/vagrant/.ssh/private_key2' | sudo tee -a /home/vagrant/.bashrc
